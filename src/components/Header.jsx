...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-white bg-opacity-0 backdrop-blur-md shadow z-10">
        ...
        <ul className="flex space-x-8 text-gray-700">
          ...
          <div className="relative">
            <Link to={"/cart"} className="hover:text-pink-600">
              ...
              <span
                className="absolute -top-1 -right-1 bg-pink-600 text-white rounded-full w-5 h-5 flex justify-center
               items-center"
              >
                {products.length}
              </span>
