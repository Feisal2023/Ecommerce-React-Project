  ...
  return (
    product && (
      <div className="max-w-4xl  mx-auto p-4 md:p-8">
        <button
          onClick={() => navigate(-1)}
          className="mb-4 bg-pink-600 text-white  px-4 py-2 rounded-lg shadow
    hover:bg-pink-700 transition-colors duration-200"
        ...
        <div className="md:flex">
          ...
          <div className="md:w-1/2 pl-4">
            ...
            <button
              className="bg-pink-600 text-white mt-4 px-5 py-2 rounded-lg shadow
          hover:bg-pink-900 transition-colors duration-200"
